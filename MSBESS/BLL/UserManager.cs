...
namespace WebAdmin.BLL
{
    public class UserManager
    {
        ...
        public void InsertUser(UserCreation User, string IsUpdate, string IsDelete, DataTable dt, string strPrivPackID)
        {
            ...
            try
            {
                objDAL.MakeTransaction(command);
            }
            catch (Exception ex)
            {
                throw (ex);
        ...
        public DataTable GetPrivPackWiseUser(string strPrivPackID)
        {
            ...
            return objDAL.CreateDT(cmd, "PrivPackWiseUser");
        }
        ...
        public DataTable SelectPrivPack(int intID)
        {
            ...
            objDAL.CreateDSFromProc(command, "PrivPack");
            return objDAL.ds.Tables["PrivPack"];
        }
        ...
        public DataTable SelectUserPriv(string UserId)
        {
            ...
            objDAL.CreateDSFromProc(command, "UserPrivs");
            return objDAL.ds.Tables["UserPrivs"];
        }
        public DataTable SelectScreenInfo()
        {
            SqlCommand command = new SqlCommand("proc_SELECT_Screen");
            objDAL.CreateDSFromProc(command, "screeninfo");
            return objDAL.ds.Tables["screeninfo"];
        }
        ...
        public DataTable SelectUserAssignment(string UserId, Int32 DivisionId, Int32 SBUId)
        {
            ...
            objDAL.CreateDSFromProc(command, "UserAssignment");
            return objDAL.ds.Tables["UserAssignment"];
        }
        ...
        public DataTable GetUserTaskPermission(string sUserId, string sViewId, string sTaskId)
        {
            ...
            if (objDAL.ds.Tables["UserTaskPermission"] != null)
            {
                objDAL.ds.Tables["UserTaskPermission"].Rows.Clear();
                objDAL.ds.Tables["UserTaskPermission"].Dispose();
            }
            ...
            return objDAL.CreateDT(cmd, "UserTaskPermission");
        }
        ...
        public DataTable SelectTaskPermission()
        {
            ...
            return objDAL.CreateDT(cmd, "TaskPermission");
        }
        #endregion
    }
}