<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ctlLeaveRecommendation.ascx.cs" Inherits="WebAdmin.UserControls.Leave.ctlLeaveRecommendation" %>
<div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Recommend Leave List</h3>
            </div>
                        ...
                        <div class="form-horizontal">
                            <div class="box-body">
                                ...
                                <div class="box-body table-responsive no-padding">
                                    ...
                                    <asp:GridView ID="grRecommendLeaveList" runat="server" Width="100%" Font-Size="9px" EmptyDataText="No Record Found"
                                        ...
                                        OnRowCommand="grRecommendLeaveList_RowCommand"
                                        PageSize="10">
