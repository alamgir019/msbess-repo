<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ctlPendingLeaveList.ascx.cs" Inherits="WebAdmin.UserControls.Leave.ctlPendingLeaveList" %>
<div class="row">
    <div class="col-md-12">
                        ...
                        <div class="form-horizontal">
                            <div class="box-body">
                                ...
                                <div class="box-body table-responsive no-padding">
                                    ...
                                    <asp:GridView ID="grPendingLeaveList" runat="server" Width="100%" Font-Size="9px" EmptyDataText="No Record Found"
                                        AutoGenerateColumns="False"
                                        DataKeyNames="LvAppID,LTypeTitle,LTypeId,LNature,AppDate,LeaveStart,LeaveEnd,LDurInDays,InsertedBy,LTReason,LAbbrName,EmpId,Fullname,SupervisorId,AppStatus,AppStatusTitle"
                                        class="table table-bordered table-hover" 
                                        OnRowCommand="grPendingLeaveList_RowCommand"
                                        PageSize="10">
