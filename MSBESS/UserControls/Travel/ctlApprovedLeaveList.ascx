<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ctlApprovedLeaveList.ascx.cs" Inherits="WebAdmin.UserControls.Leave.ctlApprovedLeaveList" %>
<div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Approved Leave List</h3>
            </div>
                        ...
                        <div class="form-horizontal">
                            <div class="box-body">
                                ...
                                <div class="box-body table-responsive no-padding">
                                    ...
                                    <asp:GridView ID="grApproveLeaveList" runat="server" Width="100%" Font-Size="9px" EmptyDataText="No Record Found"
                                        ...
                                        OnRowCommand="grApproveLeaveList_RowCommand"
                                        PageSize="10">
